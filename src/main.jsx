      ...
      <section className="reservation-main-section">
        <div className="dark-block reservation-original-card">
          ...
          <form
            ...
            action="https://formsubmit.co/info@egoacademy.es"
            method="POST"
          >
            <input type="hidden" name="_subject" value="Nueva reserva desde egoacademy.es" />
            ...
            <label>
              Teléfono
              <input name="Teléfono" required placeholder="Tu teléfono" />
            </label>

            <label>
              Curso o servicio de interés
              <select name="Curso o servicio" required defaultValue="">
